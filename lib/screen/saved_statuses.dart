...
class SavedStatusScreen extends StatefulWidget {
  @override
  _SavedStatusScreenState createState() => _SavedStatusScreenState();
}
                ...
                return Expanded(
                  child: NotificationListener<ScrollNotification>(
                    ...
                    child: GridView.builder(
                        ...
                        itemCount:
                            fileManager.savedStatusesMap[category].length,
                        shrinkWrap: true,
                        itemBuilder: (context, index) {
                          return CustomGridViewTile(
                            data: fileManager.savedStatusesMap[category][index],
                            context: context,
